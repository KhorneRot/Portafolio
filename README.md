...
## Estructura limpia para GitHub Pages

Este proyecto está organizado para publicarse desde la raíz del repositorio:
...
Ya no existe un `index.html` cargador externo ni una carpeta envolvente `treecatdesign/`. GitHub Pages puede leer directamente el `index.html` principal desde la raíz.
